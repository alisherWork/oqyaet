...
function check_($check) {
    ...
    $file              = file_get_contents('https://api.topide.com/Verify/deepsound?code=' . $check . '&success=true&url=' . $siteurl, false, stream_context_create($arrContextOptions));
    if ($file) {
                                ...
                                <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <span class="help-block">授权码请到! /////<a href="https://www.topide.com" target="_blank">顶点网免费获取</a>.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-1"></div>
